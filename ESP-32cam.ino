...
const char* ssid = "Guo Family";
const char* password = "03310621";
...
#define STORAGE_BUCKET_ID "tidealert-4d45a.appspot.com"
// For example:
...
void setup() {
  ...
  //Firebase
  // Assign the api key
  configF.api_key = "AIzaSyA69eyrrZa7JYToEDzq6CwBoy5gOmFX5dU";
  //Assign the callback function for the long running token generation task
  Firebase.begin(&configF, nullptr);
...
Serial.println("Entering loop...");
  Serial.printf("Firebase.ready(): %d, taskCompleted: %d\n", Firebase.ready(), taskCompleted);
